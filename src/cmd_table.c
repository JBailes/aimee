...
const command_t commands[] = {
    ...
    {"verify", "Cross-verify changes (delegate reviews tool, tool reviews delegate)", cmd_verify, CMD_TIER_CORE},
    ...
    {"work", "Inter-session work queue (distribute tasks across sessions)", cmd_work, CMD_TIER_ADVANCED},
