...
tests/unit-test-guardrails: $(OBJDIR)/tests/test_guardrails.o $(OBJDIR)/guardrails.o \
...
tests/unit-test-agent: $(OBJDIR)/tests/test_agent.o $(OBJDIR)/agent.o $(OBJDIR)/agent_policy.o \
                      ...
                      $(OBJDIR)/extractors_extra.o $(OBJDIR)/guardrails.o \
                      $(OBJDIR)/tasks.o $(OBJDIR)/render.o \
...
tests/unit-test-workspace: $(OBJDIR)/tests/test_workspace.o $(TEST_DATA_OBJS) \
                          ...
                          $(OBJDIR)/guardrails.o $(OBJDIR)/agent.o $(OBJDIR)/agent_policy.o \
...
tests/unit-test-context-assembly: $(OBJDIR)/tests/test_context_assembly.o $(TEST_DATA_OBJS) \
                                 ...
                                 $(OBJDIR)/guardrails.o $(OBJDIR)/workspace.o \
...
tests/unit-test-cmd-branch: $(OBJDIR)/tests/test_cmd_branch.o $(OBJDIR)/cmd_branch.o \
                           ...
                           $(OBJDIR)/mcp_git.o $(OBJDIR)/git_verify.o \
                           $(OBJDIR)/working_memory.o $(OBJDIR)/guardrails.o
	$(CC) -o $@ $^ $(TEST_L_FLAGS)
...
tests/unit-test-mcp-git: $(OBJDIR)/tests/test_mcp_git.o $(OBJDIR)/mcp_git.o \
                        ...
                        $(OBJDIR)/guardrails.o $(OBJDIR)/index.o \
